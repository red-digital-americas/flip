...
export class RoomAvailavilityComponent implements OnInit {
    ...
    get smoking() { return this.filterForm.get('smoking').value; }
    ...
    roomDetail(element: any) {
        ...
        sessionStorage.setItem('roomData', JSON.stringify(element));
    ...
    public applyFilterPeriod() {
        ...
        const params = {
            ...
            smoking: this.smoking === null ? '' : this.smoking.value,
