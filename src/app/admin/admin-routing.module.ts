...
const routes: Routes = [
  { path: '', data: { title: 'AdminApp', expectedRole: [4, 5, 1, 3] }, canActivate: [RoleGuardService],
    children: [
      ...
      { path: 'coliving', component: ColivingComponent, data: {title: 'About'} },
      { path: 'flipNetwork', component: FlipNetworkComponent, data: {title: 'Network'} },
      { path: 'memberships', component: MembershipComponent, data: {title: 'About'} },
