        ...
        success: function (data, textStatus, jqXHR) {
         //   debugger;
            ...
            for(let i = 0; i < respuesta.item.length; i++){
                ...
                plantilla += `   <img src="${slide.photomobile}" alt="${slide.title}">
                                    <div id="hidegallmap" class="header-text  ">
                                                            <div class="col-md-12 text-center text-design-leftphi">
                                                                <span>
                                                                    <p  id ="p-altata-00"; class="padding-right" style="margin-right: 8%; margin-top: 9%;">
                                                                        ${slide.desc}
                                                                    </p>
                                                                </span>
                                                                <br>
